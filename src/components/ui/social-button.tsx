...
type SocialButtonProps = Omit<ComponentProps<typeof Button>, 'variant'> & {
...
function SocialButton({
  ...
  return (
    <Button
      className={cn(
        'w-full justify-center gap-3 font-medium',
        config.className,
        className,
      )}
      {...props}
...
export { SocialButton, SocialButtonGroup }
